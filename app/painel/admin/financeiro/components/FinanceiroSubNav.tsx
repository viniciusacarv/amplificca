...
import { LayoutDashboard, Receipt, Users, Settings, Package, Truck, UserCog, HeartHandshake } from 'lucide-react'
...
const TABS = [
  ...
  { href: '/painel/admin/financeiro/patrocinios',       label: 'Patrocínios',       icon: HeartHandshake },

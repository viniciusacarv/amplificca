                          ...
                          <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-0.5">
                            ...
                            {sub.google_doc_url && (
                              <a
                                ...
                                className="inline-flex items-center gap-1 rounded-md border border-emerald-500/30 bg-emerald-500/10 px-2 py-0.5 text-xs font-medium text-emerald-400 transition-all hover:border-emerald-500/50 hover:bg-emerald-500/20 hover:text-emerald-300"
                              >

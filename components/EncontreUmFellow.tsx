...
const ESPECIALIDADES = [
  ...
  'Direito', 'Economia', 'Educação', 'Tecnologia',
  'Política', 'Comunicação', 'Gestão Pública'
]
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ marginBottom: 56 }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.45)', fontSize: 16, marginTop: 16, maxWidth: 560, lineHeight: 1.6 }}>
            Conecte veículos de comunicação com especialistas preparados para o debate público. Filtre por área de atuação ou localização.
          </p>
        </div>
        ...
        <div style={{
          ...
          <button
            onClick={() => { setBusca(''); setEstado('Todos os estados'); setEspecialidade('Todas as especialidades') }}
            style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 16 }}>
          {filtrados.map(f => (
            ...
            onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(126,211,33,0.25)'; e.currentTarget.style.background = 'rgba(126,211,33,0.03)' }}
            ...
            onClick={() => setSelected(f)}>
              ...
              <div style={{ position: 'relative', height: 200, background: 'rgba(255,255,255,0.03)', overflow: 'hidden' }}>
                ...
                <div style={{
                  ...
                  background: cor(f.area).bg,
                  border: `1px solid ${cor(f.area).border}`,
                  backdropFilter: 'blur(8px)',
                  borderRadius: 100, padding: '4px 12px',
                  fontSize: 11, color: cor(f.area).text, fontWeight: 500,
                }}>
                  {f.area}
                </div>
              </div>
              ...
              <div style={{ padding: '20px 20px 16px' }}>
                ...
                <div style={{ fontSize: 12, color: 'var(--verde)', marginBottom: 12 }}>
                  {ESTADOS_NOME[f.estado] || f.estado}
                </div>
                ...
                <div style={{ display: 'flex', gap: 8 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(255,255,255,0.12)',
                      borderRadius: 6, fontSize: 12, color: 'rgba(255,255,255,0.5)',
                      cursor: 'pointer',
                    }}
                  >
                    Ver perfil
        ...
        {filtrados.length === 0 && (
          <div style={{ textAlign: 'center', padding: '80px 0', color: 'rgba(255,255,255,0.25)', fontSize: 15 }}>
            Nenhum fellow encontrado com esses filtros.
            <br />
      ...
      {selected && (
        <div onClick={() => setSelected(null)} style={{
          ...
          <div onClick={e => e.stopPropagation()} style={{
            background: '#111', border: '1px solid rgba(126,211,33,0.2)',
            borderRadius: 16, maxWidth: 580, width: '100%', position: 'relative',
            overflow: 'hidden',
          }}>
            {/* Foto no modal */}
            <div style={{ height: 220, position: 'relative', background: '#0a0a0a' }}>
              {selected.foto_url && (
                <Image src={selected.foto_url} alt={selected.nome} fill style={{ objectFit: 'cover', objectPosition: 'center top', opacity: 0.8 }} />
              )}
            ...
            <div style={{ padding: '0 32px 32px' }}>
              <div style={{ marginBottom: 20 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  ...
                  <span style={{
                    ...
                    background: cor(selected.area).bg, color: cor(selected.area).text,
              ...
              <div style={{ display: 'flex', gap: 12 }}>
                <a href={`https://instagram.com/${selected.instagram}`} target="_blank" rel="noopener" style={{
                  ...
                  background: 'var(--verde)', color: '#000', borderRadius: 8,
                  fontSize: 14, fontWeight: 500, textDecoration: 'none',
                }}>
                  Contatar via Instagram ↗
                </a>
                <a href={`mailto:anne@institutoamplifica.com?subject=Interesse em entrevistar ${selected.nome}`} style={{
                  flex: 1, textAlign: 'center', padding: '12px',
                  background: 'transparent', color: '#fff', borderRadius: 8,
                  fontSize: 14, border: '1px solid rgba(255,255,255,0.15)', textDecoration: 'none',
                }}>

...
const VALORES = [
  ...
  { icon: '📣', titulo: 'Liberdade de Expressão', desc: 'O debate livre de ideias é essencial para uma sociedade que evolui e se corrige.' },
  { icon: '⚡', titulo: 'Império da Lei', desc: 'A lei deve ser igual para todos, sem exceções políticas ou privilégios de poder.' },
  { icon: '👤', titulo: 'Mais Indivíduo, Menos Estado', desc: 'Defendemos a autonomia individual contra o avanço do Estado em todas as esferas da vida.' },

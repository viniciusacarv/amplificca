...
const FELLOWS_DEMO: Fellow[] = [
  ...
  { id: 2,  nome: 'Ana Carolina Beltrão Peixoto',      bio: 'Administradora, Assistente Social e Pedagoga. Doutora em Serviço Social e Mestre em Meio Ambiente. Gestora Pública e Professora Universitária.', estado: 'AL', area: 'Educação',      instagram: 'acarolprofessora',  foto_url: '/fellows/ana-carolina.png',      created_at: '' },
  ...
  { id: 9,  nome: 'Ivanildo Francisco dos Santos Terceiro', bio: 'Diretor Global de Marketing da Students For Liberty. Coordena campanhas que alcançam milhões de pessoas por semana.',                       estado: 'SP', area: 'Comunicação',   instagram: 'ivanildoiii',       foto_url: '/fellows/ivanildo-terceiro.png', created_at: '' },
